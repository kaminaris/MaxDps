...
local auraMetaTable = {
    __index = function(_, spellID)
        return {
            ...
            count       = 0,
            remains     = 0,
            duration    = (spellDurationCache and spellDurationCache[spellID]) or (MaxDps.spellDurations and MaxDps.spellDurations[spellID] and MaxDps.spellDurations[spellID].duration) or 1,
            refreshable = true,
            maxStacks   = 0,
            value       = 0,
        }
...
function MaxDps:GlowConsumables()
    ...
    for itemId in pairs(MaxDps.Consumables) do
